  \section{Data sources and descriptives}
    ...
    \begin{table}[H]%
      ...
      \label{tab:popSum}%
      \begin{center}
        \input{../resrc/popSum.tex}%
        \caption*{\small Note: Population is reported in millions; the activity rate and the share aged 55+ are reported in percentages; weekly hours are reported as average hours worked per week.}
      \end{center}
    \end{table}%
